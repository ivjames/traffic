...
- Adjustable driver and traffic parameters:
  ...
  - truck share
  - bottleneck strength
- One-click timed scenarios that automatically change demand/behavior over time:
  - morning commute
  - sudden rain event
  - weekend truck wave
- Real-time stats:
...
- Scenario timelines apply staged parameter patches at specific simulation times.
